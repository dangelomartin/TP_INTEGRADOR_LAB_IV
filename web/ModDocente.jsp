...
<% Usuario usuario = UserService.usuarioLegajo(legajo,2);%>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-primary" href="ListDocentes.jsp" role="button">Volver</a>
                            <h5 class="title">Modificar Docente</h5>
                        </div>
                        <div class="card-body">
