                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a class="btn btn-success" href="AltaDocente.jsp" role="button">Agregar
                                Docente</a>
                            <h4 class="card-title">Lista Docentes</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="Tabla" class="table table-bordered"
                                    ...
                                    <c:forEach var="usuario" items="${ usuarios }">
                                        <tr id="usuario-${ usuario.getLegajo() }">
                                            ...
                                            <td>
                                                <a href="ModDocente.jsp?legajo=${ usuario.getLegajo() }" class='editar btn btn-primary'>
...
<script>
    eliminar = legajo => {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: 'docentes/elimnar?legajo=' + legajo,
                    type: 'DELETE',
                    data: {
                        legajo: legajo
                    },
